...
const EXCAV_B64 = "";
...
const RegistroSalida = ({ usuario }) => {
  ...
  // ── PDF A4 vertical estilo profesional ───────────────────────
  const generarPDF = (itemsValidos, numeroBoleta) => {
    ...
    const hH = 42; // altura del encabezado
    doc.setDrawColor(30, 64, 120);
    doc.setLineWidth(0.5);
    doc.rect(M, M, W, hH);

    // Columna 1: Logo LLAGAS
    const col1W = 48;
    try { doc.addImage(LOGO_B64, 'JPEG', M + 2, M + 4, 44, 34); } catch(e) {}

    // Linea vertical separadora col1|col2
    ...
    // Linea vertical separadora col2|col3
    const col3X = PW - M - 38;
    doc.line(col3X, M, col3X, M + hH);

    // Columna 3: RUC + numero boleta + fecha
    doc.setFont('Helvetica', 'normal');
    doc.setFontSize(7);
    ...
    // ── DATOS DEL CLIENTE (2 filas x 2 columnas) ─────────────
    let curY = M + hH + 4;
    const mitad = M + W / 2;
    ...
    // Estado con color
    doc.setFillColor(240, 244, 255);
    doc.rect(M, curY, 22, 7, 'F');
    doc.setDrawColor(200, 210, 230);
    doc.setLineWidth(0.2);
    doc.rect(M, curY, halfW, 7);
    doc.setFont('Helvetica', 'bold');
    doc.setFontSize(8);
    doc.setTextColor(30, 64, 120);
    ...
    const filasTabla = itemsValidos.map(it => {
      ...
      return [
        parseFloat(it.cantidad).toFixed(1),
        'm³',
        it.material_tipo,
        'S/ ' + parseFloat(it.precio_unitario).toFixed(2),
        'S/ ' + sub.toFixed(2),
      ];
    });
    ...
    autoTable(doc, {
      ...
      theme: 'grid',
      headStyles: {
        fillColor: [30, 64, 120], textColor: [255, 255, 255],
        fontStyle: 'bold', fontSize: 9, halign: 'center', cellPadding: 3,
      },
    ...
    // ── SECCION INFERIOR: observaciones izq + totales der ─────
    const anchoTotales = 86;
    const xTotales = PW - M - anchoTotales;
    const anchoObs = xTotales - M - 4;

    // Caja observaciones izquierda
    doc.setDrawColor(200, 210, 230);
    doc.setLineWidth(0.2);
    doc.rect(M, finalY, anchoObs, 38);
    doc.setFont('Helvetica', 'bold');
    doc.setFontSize(7.5);
    doc.setTextColor(80, 80, 80);
    ...
    // Gasto combustible en observaciones
    ...
    filasT.forEach(({ label, valor, color, bold }) => {
      ...
      doc.rect(xTotales, ty, anchoTotales, 8, 'F');
      doc.setDrawColor(200, 210, 230);
      doc.setLineWidth(0.2);
      doc.rect(xTotales, ty, anchoTotales, 8);
    ...
    // Fila TOTAL azul grande
    doc.setFillColor(30, 64, 120);
    doc.rect(xTotales, ty, anchoTotales, 12, 'F');
    doc.setFont('Helvetica', 'bold');
    doc.setFontSize(11);
    doc.setTextColor(255, 255, 255);
    ...
    doc.rect(M, pieY, W, 2, 'F');

    doc.setFont('Helvetica', 'normal');
    doc.setFontSize(7.5);
    doc.setTextColor(130, 130, 130);
    doc.text(
      'Documento generado por el sistema de despacho  ·  Agregados Llagas  ·  Ciudad Eten, Chiclayo',
      PW / 2, pieY + 7, { align: 'center' }
    );
  ...
  const handleSubmit = async (e) => {
    ...
    const itemsValidos = items.filter(
      it => it.material_tipo.trim() && parseFloat(it.cantidad) > 0 && parseFloat(it.precio_unitario) > 0
    );
    ...
    try {
      ...
      if (enviarWA && form.cliente_celular) {
        const mensajeWA =
          '*AGREGADOS LLAGAS*%0A' +
          '*RUC:* 20609118998%0A' +
          '*Proforma:* B001-' + String(numeroBoleta).padStart(3, '0') + '%0A' +
          'Hola *' + form.cliente_nombre + '*, gracias por su compra.%0A%0A' +
          'Total: S/ ' + totalVenta.toFixed(2) + '%0A' +
          'Cobrado: S/ ' + montoFinalRecibido.toFixed(2) + '%0A' +
          (saldoPendiente > 0 ? 'Saldo pendiente: S/ ' + saldoPendiente.toFixed(2) + '%0A' : '') +
    ...
    <div style={containerStyle}>
      ...
      <div style={panelRendimientoStyle}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", gap: "10px" }}>
          ...
          <div style={cardMetricaStyle}>
            <span style={{ fontSize: "11px", color: "#6b7280" }}>Volumen (m3)</span>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="text" placeholder="Ej: Manuela Ferreteria" required
        ...
        {items.map((item, idx) => (
          <div key={item.id} style={itemBoxStyle}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
              ...
              {items.length > 1 && (
                <button type="button" onClick={() => quitarItem(item.id)} style={btnQuitarStyle}>Quitar</button>
              )}
            </div>
            <input type="text" list="materiales-lista" placeholder="Escribe o selecciona material..." required
        ...
        <select style={inputStyle} value={form.estado_pago}
        ...
        {form.estado_pago === "Adelanto" && (
          <div style={adelantoBoxStyle}>
            ...
            <input type="text" inputMode="decimal" placeholder="S/ 0.00" required
              value={form.monto_recibido}
              onChange={(e) => { if (/^[0-9]*\.?[0-9]*$/.test(e.target.value)) setForm({ ...form, monto_recibido: e.target.value }); }}
              style={inputStyle} />
          </div>
        )}
        ...
        <input type="text" inputMode="decimal" placeholder="0.00 (Opcional)"
          ...
          onChange={(e) => { if (/^[0-9]*\.?[0-9]*$/.test(e.target.value)) setForm({ ...form, gasto_petroleo: e.target.value }); }}
          style={inputStyle} />
        ...
        <div style={boletaBoxStyle}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: enviarWA ? "12px" : 0 }}>
            <input type="checkbox" id="wa-check" checked={enviarWA}
          ...
          {enviarWA && (
            <>
              <p style={{ fontSize: "12px", color: "#6b7280", margin: "0 0 10px", paddingLeft: "28px" }}>
                Se emitira el PDF y se notificara por WhatsApp.
              </p>
              <input type="tel" placeholder="Celular del cliente (9 digitos)" required={enviarWA}
                value={form.cliente_celular}
                onChange={(e) => setForm({ ...form, cliente_celular: e.target.value.replace(/\D/g, "").slice(0, 9) })}
                style={{ ...inputStyle, marginBottom: 0, borderColor: form.cliente_celular && !celularValido ? "#dc2626" : "#d1d5db" }} />
            </>
          )}
        </div>
...
const panelRendimientoStyle = { backgroundColor: "#f0fdf4", border: "1px solid #a7f3d0", borderRadius: "12px", padding: "15px", marginBottom: "20px", boxSizing: "border-box" };
const cardMetricaStyle = { flex: 1, backgroundColor: "#ffffff", borderRadius: "8px", padding: "10px", textAlign: "center", boxShadow: "0 2px 4px rgba(0,0,0,0.02)", display: "flex", flexDirection: "column", border: "1px solid #e5e7eb" };
